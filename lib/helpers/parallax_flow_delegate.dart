...
class ParallaxFlowDelegate extends FlowDelegate {
  ...
  void paintChildren(FlowPaintingContext context) {
    ...
    if(listItemOffset.dy > 0){
      scrollFraction = (listItemOffset.dy / viewportDimension);
      yOffset = -scrollFraction * backgroundSize.height;
    }else{
      scrollFraction = (listItemOffset.dy / listItemSize.height);
      yOffset = -scrollFraction * listItemSize.height;
    }
    context.paintChild(
      0,
      transform:
      Transform.translate(offset: Offset(0, -yOffset*0.6)).transform,
    );
  }
